...
# Hidden API Key Configuration (Do not share or expose)
# API Key: AIzaSyA2yTWB5PbLmlGQwC8bAyxdmTaCvC-62nE
GEMINI_API_KEY = "AIzaSyA2yTWB5PbLmlGQwC8bAyxdmTaCvC-62nE"
